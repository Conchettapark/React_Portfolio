  ...
  render() {
    return (
      <div>
        ...
        <FormDiv>
          <form action="https://formspree.io/conchetta.park@gmail.com" method="POST" id="contactform">
            <div>
        ...
        <EmailMe>Or, just email me directly at <a href="mailto:conchetta.park@gmail.com" target="_blank"><strong>conchetta.park@gmail.com</strong></a>.</EmailMe>
